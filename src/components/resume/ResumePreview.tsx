...
interface Resume {
  ...
  skills: string[];
  education: Education[];
  certifications?: string[]; // Make this optional since it might come from resume_data
  resume_data?: {
...
export default function ResumePreview({
  ...
  console.log("Resume data in preview:", {
    directCertifications: resume.certifications,
    resumeDataCertifications: resume.resume_data?.certifications,
    fullResume: resume,
  });
  ...
  const content = (
    <div id="resume-preview" className="bg-white p-8 max-w-4xl mx-auto">
      ...
      {(() => {
        // Get certifications from either direct property or resume_data
        const certs =
